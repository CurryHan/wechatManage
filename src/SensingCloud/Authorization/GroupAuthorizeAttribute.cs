    ...
    public class GroupAuthorizeAttribute: AuthorizeAttribute
    {
        ...
        public string Groups
        {
            ...
            set
            {
                ...
                _groups = value;
                _groupSplit = SplitString(_groups);
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            var currentGroup = httpContext.Session[ConstConfig.SessionKey_CurrentLoginGroup] as Group;
            if (currentGroup != null && _groupSplit.Length > 0 && !_groupSplit.Any(g => g == currentGroup.GroupType.ToString()))
            {
                return false;
            }
